...
<div class="headerT ">
    <div class="mtitle">课程中心</div>
    <div class="curCart" id="curCart"></div>
</div>
...
<div class="curList">
    <ul class=" curUl">
        <li class="curLi ">
            ...
            <div class="curLiInfo">
                <h4 class="ui-nowrap"><a href="#">三分钟提高你的口语水平，让我们开始练习吧</a></h4>
                <p class="culLip">见附件附件就饿哦我饿哦我哦窝窝窝窝窝放假减肥减肥减肥减肥就附加费减肥解决方法娇滴滴的多多多多多多多多多付付付付付教我我</p>
                <span>授课老师：</span>
                <span class="curName">
                    <a href="#" class="big-link" data-reveal-id="myModal" data-animation="none">王祖贤</a> </span>
                <input type="button" name="curOrder" id="curOrder4" value="预约" class="curOrder">
            </div>
        </li>
        <li class="curLi ">
            <div class="curLiImg">
            ...
            <div class="curLiInfo">
                ...
                <span class="curName">
                    <a href="#" class="big-link" data-reveal-id="myModal" data-animation="none">王祖贤</a> </span>
                <input type="button" name="curOrder" id="curOrder3" value="预约" class="curOrder">
            </div>
        </li>
        <li class="curLi ">
            <div class="curLiImg">
            ...
            <div class="curLiInfo">
                ...
                <span class="curName">
                    <a href="#" class="big-link" data-reveal-id="myModal" data-animation="none">王祖贤</a> </span>
                <input type="button" name="curOrder" id="curOrder2" value="预约" class="curOrder">
            </div>
        </li>
        <li class="curLi ">
            <div class="curLiImg">
            ...
            <div class="curLiInfo">
                ...
                <span class="curName">
                    <a href="#" class="big-link" data-reveal-id="myModal" data-animation="none">王祖贤</a> </span>
                <input type="button" name="curOrder" id="curOrder5" value="预约" class="curOrder">
            </div>
        </li>
        <li class="curLi ">
            <div class="curLiImg">
            ...
            <div class="curLiInfo">
                ...
                <span class="curName">
                    <a href="#" class="big-link" data-reveal-id="myModal" data-animation="none">王祖贤</a> </span>
                <input type="button" name="curOrder" id="curOrder1" value="预约" class="curOrder">
            </div>
        </li>
    </ul>
...
<div id="myModal" class="reveal-modal">
    ...
    <p>老师简介老师简介老师简介老师简介老师简介老师简介老师简介老师简介老师简介老师简介老师简介老师简介老师简介老师简介</p>
